...
| Tryton sync titular-activo (v1) | Sub-workflow de negocio | `flows/flujos-dev/Tryton sync titular-activo.json` | `yjyUYjVEaZ9UniSs` |
...
- **Archivo:** `flows/flujos-dev/Tryton sync titular-activo.json` (ID `yjyUYjVEaZ9UniSs`, activo)
