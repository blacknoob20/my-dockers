...
- **Invocado por:** orquestador v2 vía `Sync titular activo` (`Execute Workflow` → ID del ambiente —casa `Yv8AlEkGEdwzRJrJ`, trabajo `yjyUYjVEaZ9UniSs`—, `waitForSubWorkflow: true`, inputs `{ok: true}`)
